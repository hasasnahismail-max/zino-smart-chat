...
def get_ai_response(prompt):
    try:
        ...
        # Define the core system instruction to enforce Ismail Bassam as the founder
        system_instruction = (
        ...
        # Try active modern models with automatic fallback and strict system instruction
